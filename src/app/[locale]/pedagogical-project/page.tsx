    ...
    <div dir={isRtl ? "rtl" : "ltr"}>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-[#64748B] text-base leading-relaxed">{t("intro.body")}</p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="flex flex-col gap-6">
            {pillars.map((pillar, i) => (
              <div
                key={i}
                className="card-hover bg-white rounded-2xl p-6 md:p-8 border border-[#E5E7EB] shadow-sm flex gap-5"
              >
                <div className="text-4xl flex-shrink-0 mt-1">{pillar.icon}</div>
                <div>
                  <h3 className="text-lg font-bold text-[#1D4395] mb-2">{pillar.title}</h3>
                  <p className="text-[#64748B] text-sm leading-relaxed">{pillar.detail}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 hero-gradient">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-[#EAF1FF] text-base leading-relaxed max-w-2xl mx-auto">{t("balance.body")}</p>
        </div>
      </section>
