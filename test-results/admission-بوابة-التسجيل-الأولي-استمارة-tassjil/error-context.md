...
- Name: admission.spec.ts >> بوابة التسجيل الأولي >> استمارة /tassjil
- Location: e2e\admission.spec.ts:16:7

# Error details

```
Error: page.goto: net::ERR_EMPTY_RESPONSE at http://127.0.0.1:3001/tassjil
Call log:
  - navigating to "http://127.0.0.1:3001/tassjil", waiting until "load"
