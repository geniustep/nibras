...
- Name: admission.spec.ts >> بوابة التسجيل الأولي >> الصفحة التعريفية /
- Location: e2e\admission.spec.ts:4:7

# Error details

```
Error: page.goto: net::ERR_EMPTY_RESPONSE at http://127.0.0.1:3001/
Call log:
