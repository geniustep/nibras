...
- Name: admission.spec.ts >> بوابة التسجيل الأولي >> صفحة النجاح /tassjil/najah
- Location: e2e\admission.spec.ts:26:7

# Error details

```
Error: page.goto: net::ERR_EMPTY_RESPONSE at http://127.0.0.1:3001/tassjil/najah?ref=NIB-2026-000042
Call log:
  - navigating to "http://127.0.0.1:3001/tassjil/najah?ref=NIB-2026-000042", waiting until "load"
